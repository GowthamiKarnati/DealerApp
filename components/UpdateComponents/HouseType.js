...
const HouseType = ({maritals}) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.title}>{!maritals ? t('updateHouseTypeTitle') : t('updateMaritalStatusTitle')}</Text>
      <View style={styles.formContainer}>
        <View style={styles.formGroup}>
        <Text style={styles.label}>{!maritals?  t('housetype'): t('maritalstatus') }</Text>
        ...
        {maritals ? (
            ...
            <Picker
              ...
              onValueChange={(itemValue, itemIndex) => setHousetype(itemValue)}
              dropdownIconColor='black'
              >
